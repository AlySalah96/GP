...
<head>
    ...
    <title>Student degree page</title>
    <!--{!!Html::image('images/favicon.png')!!}-->
    {!!Html::style('http://fonts.googleapis.com/css?family=Open+Sans:300,400,700')!!}
    {!!Html::style('css/bootstrap.min.css')!!}
    <link rel="stylesheet" href="{{asset('font/css/font-awesome.min.css')}}">       {!!Html::style('css/bootstrap-theme.css')!!}
...
<body>
    ...
    <!-- /.navbar -->
 	...
 	<header id="head" class="secondary">
            <div class="container">
                    <h1> <span>Good luck your degree is {{$studentDegree}} out of {{$totalDegree}} in true/false , multiple choice and code questions</span> </h1>
...
<h2> Go back to Student Home page  </h2>
...
<h2> review exam  </h2>
<form action="{{url('reviewExamAnnswer/')}}" type="post">
<button class="btn btn-default" >GO</button>
</form>
