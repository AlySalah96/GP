...
<body>
    ...
    <!-- /.navbar -->
 	...
 	<header id="head" class="secondary">
            <div class="container" style="width:100%;size:150px;">
                    <h1>examiner page</h1>
...
<!--   cshow all pervious exams       -->
<div style="float:left; width:30%;">
<h2> your pervious exams </h2>
<form  display="in-line" action="show/exams/{{ Auth::user()->id }} " method="POST" enctype="mulipart/form-data">
<input type="hidden" name="_token" value="{{csrf_token()}}"/>
    ...
    <div class="col-md-3 col-sm-6"> 
		...
		<div class="footer2">
            ...
            <a href="{{url('about')}}">About</a>|
              ...
              <a onclick="javascript:alert('free system ')">Price</a>
